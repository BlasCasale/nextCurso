...
const getTotalItems = (cart: { [key: string]: number }): number => {
  let items = 0
...
export const TopMenu = async () => {
  ...
  const itemsCounter = getTotalItems(cart)
    ...
    <div className="sticky z-10 top-0 h-16 border-b bg-white lg:py-2.5">
      ...
      <div className="px-6 flex items-center justify-between space-x-4">
        ...
        <div className="flex space-x-2">
          ...
          <Link href={'/dashboard/cart'} className="flex gap-2 items-center justify-center p-2 h-10 rounded-xl border bg-gray-100 focus:bg-gray-100 active:bg-gray-200">
            {itemsCounter > 0 && <span className='text-blue-800'>{itemsCounter}</span>}
